        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: 'BiSoft is a brand new Responsive Admin Dashboard Template you have always been looking for!',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Buy BiSoft!',
                    // (string | mandatory) the text inside the notification
                    text: 'BiSoft comes with a huge collection of reusable and easy customizable UI components and plugins. Buy BiSoft today!',
                    // (string | optional) the image to display on the left
                    image: './assets/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'Customize BiSoft!',
                    // (string | mandatory) the text inside the notification
                    text: 'BiSoft allows you to easily customize the theme colors and layout settings.',
                    // (string | optional) the image to display on the left
