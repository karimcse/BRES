<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index-main.aspx.cs" Inherits="BRS.Site.index_main" %>
...
<div class="header navbar navbar-inverse navbar-fixed-top">
	...
	<div class="header-inner">
		<!-- BEGIN LOGO -->
		<a class="navbar-brand" href="index-main.aspx">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="sidebar-search-wrapper">
					...
					<form class="sidebar-search" action="extra_search.aspx" method="POST">
                ...
                <li class="">
					<a href="../Reports/ReportViewer.aspx">
					<i class="fa fa-briefcase"></i>
					<span class="title">
						Reports
					</span>
...
<div class="footer">
	<div class="footer-inner">
		 2013-2014 &copy; BiSoft Technology.
	</div>
